  ...
  return (
    <div className="tatoueuseCarhaix">
       <Helmet>
        ...
        <meta
          name="description"
          content="Vous cherchez une tatoueuse à Carhaix ? Valkyr Ink vous accueille dans son salon privé à Plévin, à seulement 10 minutes. Créations sur-mesure, ambiance calme et artistique, et chèques cadeaux tatouage disponibles."
          />
        <meta
          name="keywords"
          content="Tatoueur Carhaix, tatouage Carhaix, tatouage couleur Carhaix, tatoueur proche Carhaix, chèque cadeau tatouage Carhaix, cadeau tatouage Plévin, Valkyrink Carhaix"
        />
        <meta property="og:title" content="Tatoueur Carhaix – Valkyr Ink, une tatoueuse passionnée à proximité" />
        <meta
          property="og:description"
          content="À seulement 10 min de Carhaix, Valkyr Ink propose des tatouages sur-mesure dans un cadre confidentiel et artistique, avec des chèques cadeaux tatouage."
        />
